...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin-user', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Race', path: '/races', entity: 'race', service: AccessServiceEnum.PROJECT, icon: FiFlag },
    { name: 'Timer', path: '/timers', entity: 'timer', service: AccessServiceEnum.PROJECT, icon: FiClock },
